...
function setup() {
    ...
    var width = (parseInt(prompt("Type in the width you would like for the canvas.")));
    ...
    var height = (parseInt(prompt("Type in the height you would like for the canvas.")));
...
function draw() {
    ...
    // if the xCoor of circle is greater than the width of the canvas, bounce back
    ...
    //if the yCoor of circle is greater than the height of the canvas, bounce back 
    //when circle bounces back, size changes
    ...
    for(var j = 0; j < ballList.length; j++){ //j is the first ball used to detect a collision
